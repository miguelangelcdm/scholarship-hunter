import { Heart, Sparkles, Bell, Menu, Activity, RefreshCw, Check, Moon, Sun } from "lucide-react";
  ...
  return (
    <header className="flex items-center justify-between gap-3 px-4 sm:px-6 lg:px-8 py-4 bg-card/70 backdrop-blur rounded-b-3xl border-b border-border">
      ...
      <div className="flex items-center gap-2">
        <button onClick={toggleDark} className="w-10 h-10 rounded-full bg-secondary hover:bg-muted grid place-items-center transition" aria-label="Toggle Dark Mode">
